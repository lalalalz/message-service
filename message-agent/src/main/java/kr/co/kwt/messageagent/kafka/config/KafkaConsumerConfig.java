...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<UUID, CreateMessageEvent> producerFactory() {
        ...
        props.put(SaslConfigs.SASL_JAAS_CONFIG, kafkaProperties.getSasl().getJaas());

        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<UUID, CreateMessageEvent> kafkaListenerContainerFactory(
            ConsumerFactory<UUID, CreateMessageEvent> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<UUID, CreateMessageEvent> factory =
