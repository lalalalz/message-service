...
import static kr.co.kwt.messagecore.message.domain.DomainException.ErrorCode.STATUS_UNMODIFIABLE;
import static kr.co.kwt.messagecore.message.domain.Status.*;
...
public class Message {
     ...
     */
    public static MessageBuilder emptyBuilder(TemplateEnginePort templateEnginePort) {
        return new MessageBuilder(templateEnginePort);
    }

    public static MessageBuilder defaultBuilder(TemplateEnginePort templateEnginePort) {
        return new MessageBuilder(templateEnginePort, UUID.randomUUID(), PENDING, From.SYSTEM);
    }
