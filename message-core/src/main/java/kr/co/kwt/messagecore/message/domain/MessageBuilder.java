...
import static kr.co.kwt.messagecore.message.domain.Status.Retry;
import static kr.co.kwt.messagecore.message.domain.Status.Stage;
...
public class MessageBuilder {
    ...
    public MessageBuilder(TemplateEnginePort templateEnginePort) {
        this.templateEnginePort = templateEnginePort;
    }

    public MessageBuilder(TemplateEnginePort templateEnginePort, UUID id, Status status, From from) {
        this.id = id;
        this.status = status;
        this.from = from;
